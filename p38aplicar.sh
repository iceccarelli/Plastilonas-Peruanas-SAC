...
# El conversor se escribe DENTRO del repositorio y no en /tmp: importa `sharp`,
# que vive en node_modules de este proyecto, y Node resuelve los paquetes desde
# la carpeta del archivo hacia arriba. Desde /tmp no lo encuentra y falla con
# ERR_MODULE_NOT_FOUND. Se borra en cuanto termina.
cat > ./convertir-imagenes.mjs <<'CONVERSOR'
#!/usr/bin/env node
/**
...
CONVERSOR
node ./convertir-imagenes.mjs || { rm -f ./convertir-imagenes.mjs; morir "La conversión falló."; }
rm -f ./convertir-imagenes.mjs
