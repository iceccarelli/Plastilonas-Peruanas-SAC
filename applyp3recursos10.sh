#!/usr/bin/env bash
# =============================================================================
# P3 — SILO /recursos COMPLETO: 3 → 10 GUÍAS TÉCNICAS
#
# Plastilonas Peruanas SAC. Aplica sobre main en 25a4720 o posterior.
#
# Añade 7 guías nuevas, cada una anclada a una familia que ya tiene página
# propia, y enlaza el silo de contenido con el de catálogo en ambos sentidos.
# Reescribe tres archivos completos (no aplica parches parciales), de modo que
# es idempotente: volver a ejecutarlo deja el mismo resultado.
#
# Uso:   bash apply-p3-recursos-10.sh
# =============================================================================
set -euo pipefail

if [ ! -f package.json ] || [ ! -d app/recursos ]; then
  echo "ERROR: ejecute desde la raíz del repo, con P1 (/recursos) ya aplicado." >&2
  exit 1
fi
...
echo ""
echo "=============================================================="
echo " LISTO. Esperado: 7 test files / 79 tests, y en el build:"
echo "   * /recursos/[slug]  (10 rutas)"
echo "   93 páginas estáticas generadas"
echo ""
echo " Siguiente:"
echo "   git add -A"
echo "   git commit -m 'feat(content): 7 guias tecnicas nuevas, silo /recursos a 10 articulos'"
