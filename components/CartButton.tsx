...
export default function CartButton({ className = '' }: { className?: string }) {
  ...
  return (
    ...
    >
      ...
      {count > 0 && (
        <span className="absolute -top-2 -right-2 min-w-[16px] h-4 px-1 flex items-center justify-center rounded-full bg-[#059669] text-white t-micro font-bold leading-none">
          {count}
        </span>
      )}
    </button>
